...
dag = DAG("remindo_etl_production", default_args=default_args, schedule_interval="@monthly")
...
move_data_to_landing_area = PythonOperator(
...
start_operator >> extract_operator >> move_to_landing_folder_operator >> etl_job_operator >> email_operator >> finish_operator