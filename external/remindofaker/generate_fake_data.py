# From Github repo whose name I don't currently remember
...
# TODO: convert this to Remindo-like data
...
class RemindoFake:
    def __init__(self):
        ...
        self._fake_books = [
            ...
            "Ra",
            "The Mind Illuminated: A Complete Meditation Guide IntegratingBuddhist Wisdom and Brain Science",
    ...
    def _generate_fake_review_obj(self):
        return {
            ...
            "review_rating": self._faker.pyfloat(
                right_digits=2, min_value=0, max_value=5
            ),
            ...
            "average_rating": self._faker.pyfloat(
                right_digits=2, min_value=0, max_value=5
            ),
...
if __name__ == "__main__":
    ...
    required.add_argument(
        ...
        metavar="",
        required=True,
        help="Number of records to genertae.",
    )
